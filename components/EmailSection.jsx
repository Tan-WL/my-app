        ...
        <main className="grid md:grid-cols-2 my-12 md:my-12 py-24 md:py-24 gap-4 relative" id="contact">
            <div className="z-10">
                ...
                <div className=" flex flex-row gap-4 mt-6">
                    ...
                    <Link href="https://www.linkedin.com/in/wen-liang-tan-68a838263/">
                        <Image src={LinkedinIcon} alt="Linkedin Icon" />
                    </Link>
                    <Link href="https://www.instagram.com/wl_liang_03/" className="mt-1">
                        <Image src={InstagramIcon}/>
                    </Link>
                    <Link href="mailto:wenliang0606@gmail.com" className="mt-1">
                        <Image src={GmailIcon}/>
                    </Link>
